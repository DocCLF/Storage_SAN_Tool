function FOS_BasicSwitchInfos {
    ...
    process {
        ...
        if($TD_Line_ID -eq 1){$TD_LB_sanBasicSwitchInfoOne.Visibility = "Visible";     $TD_LB_sanBasicSwitchInfoOne.Content = "$($FOS_SwGeneralInfos.'Swicht Name')"  ;$TD_CB_SAN_DG1.Visibility="visible";$TD_LB_SAN_DG1.Visibility="visible"; $TD_LB_SAN_DG1.Content=$TD_Device_DeviceName}
        if($TD_Line_ID -eq 2){$TD_LB_sanBasicSwitchInfoTwo.Visibility = "Visible";     $TD_LB_sanBasicSwitchInfoTwo.Content = "$($FOS_SwGeneralInfos.'Swicht Name')"  ;$TD_CB_SAN_DG2.Visibility="visible";$TD_LB_SAN_DG2.Visibility="visible"; $TD_LB_SAN_DG2.Content=$TD_Device_DeviceName}
        if($TD_Line_ID -eq 3){$TD_LB_sanBasicSwitchInfoThree.Visibility = "Visible";   $TD_LB_sanBasicSwitchInfoThree.Content = "$($FOS_SwGeneralInfos.'Swicht Name')";$TD_CB_SAN_DG3.Visibility="visible";$TD_LB_SAN_DG3.Visibility="visible"; $TD_LB_SAN_DG3.Content=$TD_Device_DeviceName}
        if($TD_Line_ID -eq 4){$TD_LB_sanBasicSwitchInfoFour.Visibility = "Visible";    $TD_LB_sanBasicSwitchInfoFour.Content = "$($FOS_SwGeneralInfos.'Swicht Name')" ;$TD_CB_SAN_DG4.Visibility="visible";$TD_LB_SAN_DG4.Visibility="visible"; $TD_LB_SAN_DG4.Content=$TD_Device_DeviceName}
        if($TD_Line_ID -eq 5){$TD_LB_sanBasicSwitchInfoFive.Visibility = "Visible";    $TD_LB_sanBasicSwitchInfoFive.Content = "$($FOS_SwGeneralInfos.'Swicht Name')" ;$TD_CB_SAN_DG5.Visibility="visible";$TD_LB_SAN_DG5.Visibility="visible"; $TD_LB_SAN_DG5.Content=$TD_Device_DeviceName}
        if($TD_Line_ID -eq 6){$TD_LB_sanBasicSwitchInfoSix.Visibility = "Visible";     $TD_LB_sanBasicSwitchInfoSix.Content = "$($FOS_SwGeneralInfos.'Swicht Name')"  ;$TD_CB_SAN_DG6.Visibility="visible";$TD_LB_SAN_DG6.Visibility="visible"; $TD_LB_SAN_DG6.Content=$TD_Device_DeviceName}
        if($TD_Line_ID -eq 7){$TD_LB_sanBasicSwitchInfoSeven.Visibility = "Visible";   $TD_LB_sanBasicSwitchInfoSeven.Content = "$($FOS_SwGeneralInfos.'Swicht Name')";$TD_CB_SAN_DG7.Visibility="visible";$TD_LB_SAN_DG7.Visibility="visible"; $TD_LB_SAN_DG7.Content=$TD_Device_DeviceName}
        if($TD_Line_ID -eq 8){$TD_LB_sanBasicSwitchInfoEight.Visibility = "Visible";   $TD_LB_sanBasicSwitchInfoEight.Content = "$($FOS_SwGeneralInfos.'Swicht Name')";$TD_CB_SAN_DG8.Visibility="visible";$TD_LB_SAN_DG8.Visibility="visible"; $TD_LB_SAN_DG8.Content=$TD_Device_DeviceName}

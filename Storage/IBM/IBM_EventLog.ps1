function IBM_EventLog {
    ...
    process{
        ...
        if($TD_Line_ID -eq 1){$TD_lb_StoEventLogOne.Visibility="visible"  ;$TD_lb_StoEventLogOne.Content= $TD_Device_DeviceName ;$TD_CB_STO_DG1.IsChecked="true";$TD_CB_STO_DG1.Visibility="visible";$TD_LB_STO_DG1.Visibility="visible"; $TD_LB_STO_DG1.Content=$TD_Device_DeviceName}
        if($TD_Line_ID -eq 2){$TD_lb_StoEventLogTwo.Visibility="visible"  ;$TD_lb_StoEventLogTwo.Content=$TD_Device_DeviceName  ;$TD_CB_STO_DG2.IsChecked="true";$TD_CB_STO_DG2.Visibility="visible";$TD_LB_STO_DG2.Visibility="visible"; $TD_LB_STO_DG2.Content=$TD_Device_DeviceName}
        if($TD_Line_ID -eq 3){$TD_lb_StoEventLogThree.Visibility="visible";$TD_lb_StoEventLogThree.Content=$TD_Device_DeviceName;$TD_CB_STO_DG3.IsChecked="true";$TD_CB_STO_DG3.Visibility="visible";$TD_LB_STO_DG3.Visibility="visible"; $TD_LB_STO_DG3.Content=$TD_Device_DeviceName}
        if($TD_Line_ID -eq 4){$TD_lb_StoEventLogFour.Visibility="visible" ;$TD_lb_StoEventLogFour.Content=$TD_Device_DeviceName ;$TD_CB_STO_DG4.IsChecked="true";$TD_CB_STO_DG4.Visibility="visible";$TD_LB_STO_DG4.Visibility="visible"; $TD_LB_STO_DG4.Content=$TD_Device_DeviceName}
        if($TD_Line_ID -eq 5){$TD_lb_StoEventLogFive.Visibility="visible" ;$TD_lb_StoEventLogFive.Content=$TD_Device_DeviceName ;$TD_CB_STO_DG5.IsChecked="true";$TD_CB_STO_DG5.Visibility="visible";$TD_LB_STO_DG5.Visibility="visible"; $TD_LB_STO_DG5.Content=$TD_Device_DeviceName}  
        if($TD_Line_ID -eq 6){$TD_lb_StoEventLogSix.Visibility="visible"  ;$TD_lb_StoEventLogSix.Content=$TD_Device_DeviceName  ;$TD_CB_STO_DG6.IsChecked="true";$TD_CB_STO_DG6.Visibility="visible";$TD_LB_STO_DG6.Visibility="visible"; $TD_LB_STO_DG6.Content=$TD_Device_DeviceName}  
        if($TD_Line_ID -eq 7){$TD_lb_StoEventLogSeven.Visibility="visible";$TD_lb_StoEventLogSeven.Content=$TD_Device_DeviceName;$TD_CB_STO_DG7.IsChecked="true";$TD_CB_STO_DG7.Visibility="visible";$TD_LB_STO_DG7.Visibility="visible"; $TD_LB_STO_DG7.Content=$TD_Device_DeviceName}
        if($TD_Line_ID -eq 8){$TD_lb_StoEventLogEight.Visibility="visible";$TD_lb_StoEventLogEight.Content=$TD_Device_DeviceName;$TD_CB_STO_DG8.IsChecked="true";$TD_CB_STO_DG8.Visibility="visible";$TD_LB_STO_DG8.Visibility="visible"; $TD_LB_STO_DG8.Content=$TD_Device_DeviceName}

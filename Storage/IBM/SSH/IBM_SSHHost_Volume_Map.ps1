function IBM_SSHHost_Volume_Map {
    <#
    .SYNOPSIS
    ...
    .LINK
        https://github.com/DocCLF/ps_collection/blob/main/IBM_SSHHost_Volume_Map.ps1
    .EXAMPLE
        IBM_SSHHost_Volume_Map -UserName monitor_user -DeviceIP 8.8.8.8
        HostID      : 91                                                                                                        
        ...
        Capacity    : 200.00GB  
    .EXAMPLE
        IBM_SSHHost_Volume_Map -UserName monitor_user -DeviceIP 8.8.8.8 -FilterType Host -Export yes
